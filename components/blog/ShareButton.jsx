...
const ShareButton = ({ baseUrl }) => {
    ...
    return (
        <div className="relative ">
            ...
            {showSharePopup && (
                <div className="absolute top-full mt-2 right-0 bg-white p-2 border border-gray-300 rounded-md shadow-lg z-10">
                    <p className="text-sm mb-2 text-black font-bold text-center">Share </p>
            ...
            {showCopiedPopup && (
                <div className="absolute -bottom-[60px] bg-white w-[190px] text-black -left-[150px] ml-2 border text-sm p-2 rounded-md shadow-md z-20">
